...
## Remaining: Group 7 (ADRs), Group 8 (standing-spec prose), Group 9 (docs), Group 10 (grep gate + final validation + human-verify 10.4). All doc/spec/ADR — no compiled-code gates except Group 10's final full-gate sweep.
