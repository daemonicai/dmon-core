...
- FROM: `### Requirement: Gateway process is started on app launch and restarted on crash`
- TO: `### Requirement: Network host process is started on app launch and restarted on crash`
