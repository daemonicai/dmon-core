...
public class DmonAIFunctionFactoryTests
{
    [Fact]
    ...
    public void Create_FromDelegate_NullMethod_ThrowsArgumentNullException()
    {
        var ex = Assert.Throws<ArgumentNullException>(() =>
            DmonAIFunctionFactory.Create((Delegate)null!, "Name"));
    ...
    public void Create_FromDelegate_WithOptions_SetsNameFromOptions()
    {
        ...
        var fn = DmonAIFunctionFactory.Create(() => 42, options);
    ...
    {
        var ex = Assert.Throws<ArgumentNullException>(() =>
            DmonAIFunctionFactory.Create((MethodInfo)null!, target: null, "Name"));
    ...
    {
        var fn1 = DmonAIFunctionFactory.Create(() => 1, "Func1");
        var fn2 = DmonAIFunctionFactory.Create(() => 2, "Func2");
