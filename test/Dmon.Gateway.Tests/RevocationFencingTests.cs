...
public sealed class RevocationFencingTests : IDisposable
{
    ...
    /// <summary>
    /// Minimal <see cref="IGatewayConnection"/> that records whether <see cref="Abort"/> was called.
    /// </summary>
    private sealed class AbortRecordingConnection(string keyId) : IGatewayConnection
    {
