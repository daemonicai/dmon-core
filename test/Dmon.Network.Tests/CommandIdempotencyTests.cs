...
///
/// Each test drives <see cref="NetworkConnectionEndpoint.RunForwardingLoopForTestAsync"/> over
/// an in-memory <see cref="WebSocket"/> seam and asserts on both core-stdin writes and the
/// frames sent back through the <see cref="INetworkConnection"/> recording.
/// </summary>
