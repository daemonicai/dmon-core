...
public sealed class SessionHandlerTests
{
    ...
    /// </summary>
    private sealed class GatedConnection : INetworkConnection
    {
    ...
    /// </summary>
    private sealed class FailingConnection : INetworkConnection
    {
    ...
    /// </summary>
    private sealed class AbortingConnection : INetworkConnection
    {
        private readonly List<string> _frames = [];
        private readonly Lock _gate = new();
