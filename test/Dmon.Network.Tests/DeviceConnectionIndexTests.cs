...
public sealed class DeviceConnectionIndexTests
{
    ...
    public void Add_ThenGetConnections_ContainsConnection()
    {
        ...
        IReadOnlyCollection<INetworkConnection> result = index.GetConnections("k1");
    ...
    public void GetConnections_ReturnsSnapshot_NotLiveView()
    {
        ...
        index.Add("k1", connA);
        IReadOnlyCollection<INetworkConnection> snapshot = index.GetConnections("k1");
    ...
    /// </summary>
    private sealed class KeyedConnection(string keyId) : INetworkConnection
    {
    ...
    /// </summary>
    private sealed class NullKeyConnection : INetworkConnection
    {
