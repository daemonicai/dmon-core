...
/// <see cref="NetworkConnectionEndpoint.HandleCreateAsync"/>.
///
...
/// </summary>
public sealed class NetworkCreateE2ETests
{
    // =========================================================================
    // 2.2 — Happy path
    // =========================================================================
    ...
    public async Task HandleCreate_HappyPath_CreatedFrameSent_HandlerRegistered()
    {
        ...
        NetworkConnectionEndpoint endpoint = MakeEndpoint(registry, launcher);
    ...
    public async Task HandleCreate_HandshakeTimeout_CoreTornDown_TimeoutRejectionSent()
    {
        ...
        NetworkOptions opts = new() { CreateHandshakeTimeoutSeconds = 1, MaxConcurrentHandlers = 10 };
        NetworkConnectionEndpoint endpoint = MakeEndpoint(registry, launcher, opts);
    ...
    public async Task HandleCreate_CapReached_CapRejectionSent_SpawnedCoreTornDown()
    {
        ...
        CapturingWebSocket socket = new();
        NetworkOptions opts = new() { MaxConcurrentHandlers = 1, CreateHandshakeTimeoutSeconds = 30 };
        NetworkConnectionEndpoint endpoint = MakeEndpoint(registry, launcher, opts);
    ...
    /// <summary>
    /// Builds a <see cref="NetworkConnectionEndpoint"/> wired with the supplied
    ...
    {
        NetworkOptions opts = options ?? new NetworkOptions();
        ...
        return new NetworkConnectionEndpoint(
            ...
            new NetworkConnectionEndpoint.TestOptions
            {
                ...
                Options = new NetworkConnectionEndpoint.StaticOptionsMonitor(opts),
            },
    ...
    /// <see cref="NetworkCreateFlowTests"/>.
    /// </summary>
