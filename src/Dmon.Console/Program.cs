...
{
    System.Console.WriteLine("dmon — .NET-native coding agent (console host)");
    System.Console.WriteLine("Usage: dmon [--core-path <path>]");
    System.Console.WriteLine("  --core-path   Path to Dmon.Core.dll");
