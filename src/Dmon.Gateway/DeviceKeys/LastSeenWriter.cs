...
internal sealed class LastSeenWriter
{
    ...
    internal static LastSeenWriter CreateNoOp() =>
        new(path: null, options: new StaticOptions(new GatewayOptions()), timeProvider: TimeProvider.System,
    ...
    private sealed class StaticOptions : IOptionsMonitor<GatewayOptions>
    {
        private readonly GatewayOptions _value;

        internal StaticOptions(GatewayOptions value) => _value = value;
