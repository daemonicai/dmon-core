...
/// <see cref="IDaemonExtension"/> class, generates a .csproj, and extracts
...
public sealed class PromoteService
{
    ...
    /// Name for the generated <see cref="IDaemonExtension"/> class.
        ...
        string cleanedBody)
    {
        ...
        sb.AppendLine($"/// </summary>");
        sb.AppendLine($"public sealed class {className} : IDaemonExtension");
        sb.AppendLine("{");
        ...
        List<ExtractedPackageReference> packages)
    {
        ...
        sb.AppendLine("    <PackageReference Include=\"Daemon.Extensions\" Version=\"*\" />");
        sb.AppendLine("  </ItemGroup>");
