...
///      - Known: wrap the socket in <see cref="WebSocketNetworkConnection"/>, call
...
/// </summary>
public sealed class NetworkConnectionEndpoint
{
    ...
    private readonly ILogger<NetworkConnectionEndpoint> _logger;
    ...
    internal NetworkConnectionEndpoint(
        ...
        ILogger<NetworkConnectionEndpoint> logger)
    {
        _registry = registry;
    ...
    /// <summary>
    /// Collaborator bag for the <see cref="NetworkConnectionEndpoint(SessionRegistry,TestOptions,ILogger{NetworkConnectionEndpoint})"/>
    ...
    internal sealed record TestOptions
    {
        ...
        public IOptionsMonitor<NetworkOptions> Options { get; init; } = new StaticOptionsMonitor(new NetworkOptions());
    ...
    internal sealed class StaticOptionsMonitor : IOptionsMonitor<NetworkOptions>
    {
    ...
    public async Task HandleAsync(HttpContext context)
    {
        ...
        using WebSocketNetworkConnection connection = new(socket, authResult.KeyId);
