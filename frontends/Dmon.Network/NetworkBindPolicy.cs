...
/// </summary>
internal static class NetworkBindPolicy
{
    /// <summary>
    /// Validates <paramref name="bindAddress"/> against the bind policy.
    /// </summary>
    /// <param name="bindAddress">The full URL string from <see cref="NetworkOptions.BindAddress"/>.</param>
    /// <param name="allowNonLoopback">Value of <see cref="NetworkOptions.AllowNonLoopbackBind"/>.</param>
    /// <returns>
