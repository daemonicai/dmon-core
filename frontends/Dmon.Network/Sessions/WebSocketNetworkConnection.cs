...
/// <summary>
/// Wraps a <see cref="WebSocket"/> as an <see cref="INetworkConnection"/>.
...
/// </summary>
internal sealed class WebSocketNetworkConnection : INetworkConnection, IDisposable
{
    private readonly WebSocket _socket;
    private readonly SemaphoreSlim _sendLock = new(1, 1);

    public WebSocketNetworkConnection(WebSocket socket, string? keyId = null)
    {
        _socket = socket;
        KeyId = keyId;
    }
