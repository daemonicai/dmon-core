...
/// <list type="bullet">
///   <item>Idle detached (no turn in flight): reap after <see cref="NetworkOptions.IdleDetachedTtlMinutes"/>.</item>
///   <item>Detached with turn in flight: reap after <see cref="NetworkOptions.RunningTurnTtlMinutes"/>
...
public sealed class SessionReaper : BackgroundService
{
    ...
    {
        NetworkOptions opts = _options.CurrentValue;
